package com.vaticle.web.docs.server;

import com.vaticle.web.main.server.CommandLineOptions;
...
public class Server {
    ...
    public static void main(String[] args) {
        ...
        Resources resources = new Resources(commandLineOptions.get().resourcesDir(), Paths.get("conf", "web-docs.properties"));
